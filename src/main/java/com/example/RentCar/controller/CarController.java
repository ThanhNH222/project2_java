...
public class CarController {
    ...
    public ResponseEntity<String> checkAvailability(
        ...
        try {
            ...
            LocalTime pickupLocalTime = LocalTime.parse(pickupTime, DateTimeFormatter.ofPattern("H:mm"));

            LocalDate dropoffLocalDate = LocalDate.parse(dropoffDate);
            LocalTime dropoffLocalTime = LocalTime.parse(dropoffTime, DateTimeFormatter.ofPattern("H:mm"));
